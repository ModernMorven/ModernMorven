  ...
  return
    ...
    try {
      const randomNumber = Math.floor(10000 + Math.random() * 90000);
         ...
         const response=await fetch("http://localhost:8000/CMAIL/SENDOTP",{
           method:"POST",
...
//  else{
//     try {
//       const response=await fetch("http://localhost:8000/CMAIL/FIND",{
//         method:"POST",
...
//           const randomString = randomNumber.toString();
//          setgeneratenum(randomString);
//           // sendingverificationmail(data._id,generatenum);
...
//     } catch (error) {
//       setemailerror("ERROR WHILE UPLOARDING handle submission");
//       setloader('off')
//     }
//   }
//   }
  ...
  const changepassword=async(e)=>{
    ...
    if(password===confirmpassowrd){
      setloader('on');
      try {
        const response= await fetch("http://localhost:8000/CMAIL/FIND/updatepassword",{
          method:'post',
        ...
        <div className="row justify-content-center">
            <div className="col-md-9 col-lg-12 col-xl-10">
                ...
                <div className="text-center mb-2">
                        <Link className="small" to="/CustomerRegistration">Create an Account!</Link>
                    </div>
                            <div className="text-center"><Link className="small" to="/Customerlogin">Already have an account? Login!</Link>
                        </div>
                </div>
       </div>
          </div>
