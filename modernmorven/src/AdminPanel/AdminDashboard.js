...
useEffect(() => {
    ...
    const fetchOrders=async()=>{
        try {
            const response= await fetch("http://localhost:8000/admin/main/showOrders");
    ...
    const fetchreviews=async()=>{
        try {
            const response= await fetch("http://localhost:8000/admin/main/showReviews");
            const data= await response.json();
            if(response.ok&&!data.message){
                setreviews(data);
            }else{
    ...
    const fetchRevenue=async()=>{
        try {
            const response= await fetch("http://localhost:8000/admin/main/showRevenue");
            const data= await response.json();
            if(response.ok&&!data.message){
                setrevenue(data);
            }else{
    ...
    const fetchcustomers=async()=>{
        try {
            const response= await fetch("http://localhost:8000/admin/main/showcustomers");
            const data= await response.json();
            if(response.ok&&!data.message){
                setcustomers(data);
            }else{
