...
function ManageAccessA() {
  ...
  const fetchadmin=async()=>{
    ...
    try {
      const response= await fetch("https://backendapi.modernmorven.com/apisingle/admins",{
        method:"POST",
  ...
  const handleSubmissionadmin=async(e)=>{
    e.preventDefault();
    try {
      const response= await fetch("https://backendapi.modernmorven.com/Admin/SEND/Edit/profile",{
        method:"POST",
        body:JSON.stringify({
          "key":stored._id,
  ...
  const handleDelete=async()=>{
    try {
      const response= await fetch("https://backendapi.modernmorven.com/Admin/Access/delete ",{
        method:"POST",
        body:JSON.stringify({
          "key":stored._id,
      }),
  ...
  const handleEnable=async(check)=>{
    try {
      const response= await fetch("https://backendapi.modernmorven.com/Admin/Access/Add/remove ",{
        method:"POST",
        body:JSON.stringify({
          "key":stored._id,
          "enable": check
